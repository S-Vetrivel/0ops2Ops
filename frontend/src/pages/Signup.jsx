...
import { GOOGLE_AUTH_URL, SignUp } from "../services/api";
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            type="button"
            className="w-full flex items-center justify-center gap-3 py-3.5 rounded-2xl border border-gray-700/30 bg-black text-white font-medium text-sm transition-all duration-300 hover:bg-gray-900 hover:border-gray-500 active:scale-[0.98]"
            style={{ color: "white" }}
          >
